...
# steps         :   Integer vector. Vector of peeling steps at which to plot the in-box samples and box vertices.
#                   Defaults to the last peeling step.
...
# col           :   Integer vector of symbol color. Defaults to 1.
# cex           :   Symbol expansion. Defaults to 0.7.
# box.col       :   Integer vector of line color of the box vertices. Defaults to 1.
...
plot.boxtraj.PRSP <- function(x,
  ...
  if (x$plot) {
    ...
    boxtrajplot <- function(object,
        ...
        for (j in used) {
            plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.rules$mean[,j], type='s', col=col, lty=lty,
        ...
        par(mfg=c(nr-1, 1))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.support, type='s', col=col, lty=lty, lwd=lwd,
        ...
        par(mfg=c(nr-1, 2))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.max.time.bar, type='s', col=col, lty=lty, lwd=lwd,
        ...
        if (add.legend)
            legend("bottomright", inset=0.01, legend=text.legend, lty=lty, col=col, lwd=lwd, cex=0.7)
        par(mfg=c(nr-1, 3))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.min.prob.bar, type='s', col=col, lty=lty, lwd=lwd,
        ...
        if (add.legend)
            legend("bottomright", inset=0.01, legend=text.legend, lty=lty, col=col, lwd=lwd, cex=0.7)
        par(mfg=c(nr, 1))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.lhr, type='s', col=col, lty=lty, lwd=lwd,
        ...
        par(mfg=c(nr, 2))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.lrt, type='s', col=col, lty=lty, lwd=lwd,
             main="LRT trajectory",
        ...
        if (add.legend)
            legend("top", inset=0.01, legend=text.legend, lty=lty, col=col, lwd=lwd, cex=0.7)
        par(mfg=c(nr, 3))
        plot(object$cvfit$cv.stats$mean$cv.support, object$cvfit$cv.stats$mean$cv.cer, type='s', col=col, lty=lty, lwd=lwd,
             main="CER trajectory",
             xlim=range(0,1), ylim=range(0, 1),
...
plot.boxtrace.PRSP <- function(x,
  ...
  if (x$plot) {
    ...
    boxtraceplot <- function(object,
        ...
        boxcut.scaled <- scale(x=object$cvfit$cv.rules$mean, center=center, scale=scale)
        plot(object$cvfit$cv.stats$mean$cv.support, boxcut.scaled[,1], type='n',
        ...
        plot(object$cvfit$cv.stats$mean$cv.support[-object$cvfit$cv.nsteps], object$cvfit$cv.trace$mode[-1],
